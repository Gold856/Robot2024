...
class PoseEstimationSubsystemTest {
	...
	void testRotation() {
		...
		assertEquals(45, PoseEstimationSubsystem.getRotation(pose, new Translation2d(2, 1)).getDegrees(), 0.001);
		assertEquals(90, PoseEstimationSubsystem.getRotation(pose, new Translation2d(1, 1)).getDegrees(), 0.001);
		assertEquals(135, PoseEstimationSubsystem.getRotation(pose, new Translation2d(0, 1)).getDegrees(), 0.001);
		assertEquals(-135, PoseEstimationSubsystem.getRotation(pose, new Translation2d(0, -1)).getDegrees(), 0.001);
		assertEquals(-90, PoseEstimationSubsystem.getRotation(pose, new Translation2d(1, -1)).getDegrees(), 0.001);
		assertEquals(-45, PoseEstimationSubsystem.getRotation(pose, new Translation2d(2, -1)).getDegrees(), 0.001);
	}
	...
	void testDistance() {
		var pose = new Pose2d(1, 0, Rotation2d.fromDegrees(0));
		assertEquals(Math.sqrt(2), PoseEstimationSubsystem.getDistance(pose, new Translation2d(2, 1)), 0.001);
		assertEquals(1, PoseEstimationSubsystem.getDistance(pose, new Translation2d(1, 1)), 0.001);
		assertEquals(Math.sqrt(2), PoseEstimationSubsystem.getDistance(pose, new Translation2d(0, 1)), 0.001);
		assertEquals(Math.sqrt(2), PoseEstimationSubsystem.getDistance(pose, new Translation2d(0, -1)), 0.001);
		assertEquals(1, PoseEstimationSubsystem.getDistance(pose, new Translation2d(1, -1)), 0.001);
		assertEquals(Math.sqrt(2), PoseEstimationSubsystem.getDistance(pose, new Translation2d(2, -1)), 0.001);
	}
	...
	void testTransform() {
		...
		assertEquals("Transform2d(Translation2d(X: 1.00, Y: 1.00), Rotation2d(Rads: 0.79, Deg: 45.00))", "" +
				PoseEstimationSubsystem.getTransform(pose, new Translation2d(2, 1)));
		assertEquals("Transform2d(Translation2d(X: 0.00, Y: 1.00), Rotation2d(Rads: 1.57, Deg: 90.00))", "" +
				PoseEstimationSubsystem.getTransform(pose, new Translation2d(1, 1)));
		assertEquals("Transform2d(Translation2d(X: -1.00, Y: 1.00), Rotation2d(Rads: 2.36, Deg: 135.00))", "" +
				PoseEstimationSubsystem.getTransform(pose, new Translation2d(0, 1)));
		assertEquals("Transform2d(Translation2d(X: -1.00, Y: -1.00), Rotation2d(Rads: -2.36, Deg: -135.00))", "" +
				PoseEstimationSubsystem.getTransform(pose, new Translation2d(0, -1)));
		assertEquals("Transform2d(Translation2d(X: 0.00, Y: -1.00), Rotation2d(Rads: -1.57, Deg: -90.00))", "" +
				PoseEstimationSubsystem.getTransform(pose, new Translation2d(1, -1)));
